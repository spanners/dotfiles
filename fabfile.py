...
def apt_get():
    ...
    local('sudo apt-get install ruby ruby-dev zsh tk vim-gtk wget curl cabal-install rxvt-unicode xmonad xmobar suckless-tools xautolock conky vlc thunar thunar-volman p7zip wxgtk2.8 unrar unzip keepassx happy libssl-dev mono-dmcs xdotool xclip')
